...
class AtmBsrp(models.Model):
    ...
    dept_no = models.CharField(db_column='DEPT_NO', max_length=6)  # Field name made lowercase.
    empl_no = models.CharField(db_column='EMPL_NO', max_length=50)  # Field name made lowercase.
    ...
    prepay_amt = models.DecimalField(db_column='PREPAY_AMT', max_digits=13, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    btrps_stl_yn = models.CharField(db_column='BTRPS_STL_YN', max_length=1, blank=True, null=True)  # Field name made lowercase.
    btrps_tamt = models.DecimalField(db_column='BTRPS_TAMT', max_digits=13, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
...
class BimAtend(models.Model):
    corp_no = models.IntegerField(db_column='CORP_NO', primary_key=True)  # Field name made lowercase.
    labortime_type = models.CharField(db_column='LABORTIME_TYPE', max_length=6)  # Field name made lowercase.
    labor_time_nm = models.CharField(db_column='LABOR_TIME_NM', max_length=30, blank=True, null=True)  # Field name made lowercase.
    st_time = models.CharField(db_column='ST_TIME', max_length=10, blank=True, null=True)  # Field name made lowercase.
...
class BimHday(models.Model):
    corp_no = models.IntegerField(db_column='CORP_NO', primary_key=True)  # Field name made lowercase.
    std_year = models.CharField(db_column='STD_YEAR', max_length=4)  # Field name made lowercase.
    hday_date = models.CharField(db_column='HDAY_DATE', max_length=4)  # Field name made lowercase.
    hday_nm = models.CharField(db_column='HDAY_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class BimOfcps(models.Model):
    corp_no = models.IntegerField(db_column='CORP_NO', primary_key=True)  # Field name made lowercase.
    ofcps = models.CharField(db_column='OFCPS', max_length=6)  # Field name made lowercase.
    ofcps_nm = models.CharField(db_column='OFCPS_NM', max_length=30, blank=True, null=True)  # Field name made lowercase.
    state = models.CharField(db_column='STATE', max_length=1, blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    reg_id = models.CharField(db_column='REG_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
    upt_dtime = models.DateTimeField(db_column='UPT_DTIME', blank=True, null=True)  # Field name made lowercase.
...
class BimSalary(models.Model):
    corp_no = models.IntegerField(db_column='CORP_NO', primary_key=True)  # Field name made lowercase.
    salary_item = models.CharField(db_column='SALARY_ITEM', max_length=6)  # Field name made lowercase.
    salary_type = models.CharField(db_column='SALARY_TYPE', max_length=1)  # Field name made lowercase.
    ...
    std_info_val = models.CharField(db_column='STD_INFO_VAL', max_length=4, blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    reg_id = models.CharField(db_column='REG_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
    upt_dtime = models.DateTimeField(db_column='UPT_DTIME', blank=True, null=True)  # Field name made lowercase.
    upt_id = models.CharField(db_column='UPT_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
...
class CmmCode(models.Model):
    ...
    cd_val = models.CharField(db_column='CD_VAL', max_length=250, blank=True, null=True)  # Field name made lowercase.
...
class CmmLogin(models.Model):
    ...
    perm_id = models.CharField(db_column='PERM_ID', max_length=4, blank=True, null=True)  # Field name made lowercase.
    empl_no = models.CharField(db_column='EMPL_NO', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class CmmMunu(models.Model):
    ...
    pgm_id = models.CharField(db_column='PGM_ID', max_length=10, blank=True, null=True)  # Field name made lowercase.
    use_yn = models.CharField(db_column='USE_YN', max_length=1, blank=True, null=True)  # Field name made lowercase.
    remark = models.CharField(db_column='REMARK', max_length=200, blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    reg_id = models.CharField(db_column='REG_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
...
class CmmMunuperm(models.Model):
    menu_id = models.CharField(db_column='MENU_ID', primary_key=True, max_length=4)  # Field name made lowercase.
    perm_id = models.CharField(db_column='PERM_ID', max_length=4)  # Field name made lowercase.
    parent_menu_id = models.CharField(db_column='PARENT_MENU_ID', max_length=4, blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    reg_id = models.CharField(db_column='REG_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
    upt_dtime = models.DateTimeField(db_column='UPT_DTIME', blank=True, null=True)  # Field name made lowercase.
...
class ComAtendlst(models.Model):
    grp_no = models.IntegerField(db_column='GRP_NO', primary_key=True)  # Field name made lowercase.
    lcode = models.CharField(db_column='LCODE', max_length=4)  # Field name made lowercase.
    scode = models.CharField(db_column='SCODE', max_length=6)  # Field name made lowercase.
    st_time = models.CharField(db_column='ST_TIME', max_length=10, blank=True, null=True)  # Field name made lowercase.
    end_time = models.CharField(db_column='END_TIME', max_length=10, blank=True, null=True)  # Field name made lowercase.
...
class ComCorp(models.Model):
    ...
    repre_nm = models.CharField(db_column='REPRE_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bizm_no = models.CharField(db_column='BIZM_NO', max_length=13, blank=True, null=True)  # Field name made lowercase.
    repre_telno = models.CharField(db_column='REPRE_TELNO', max_length=30, blank=True, null=True)  # Field name made lowercase.
    ...
    mngr_nm = models.CharField(db_column='MNGR_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ofcps = models.CharField(db_column='OFCPS', max_length=6, blank=True, null=True)  # Field name made lowercase.
    corp_telno = models.CharField(db_column='CORP_TELNO', max_length=30, blank=True, null=True)  # Field name made lowercase.
    email = models.CharField(db_column='EMAIL', max_length=40, blank=True, null=True)  # Field name made lowercase.
    mobile_no = models.CharField(db_column='MOBILE_NO', max_length=30, blank=True, null=True)  # Field name made lowercase.
    mngr_id = models.CharField(db_column='MNGR_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
    dept_info = models.IntegerField(db_column='DEPT INFO', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ofcps_info = models.IntegerField(db_column='OFCPS INFO', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    atend_info = models.IntegerField(db_column='ATEND INFO', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    salary_info = models.IntegerField(db_column='SALARY INFO', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class ComCorphis(models.Model):
    ...
    mobile_no = models.CharField(db_column='MOBILE_NO', max_length=30, blank=True, null=True)  # Field name made lowercase.
    mngr_id = models.CharField(db_column='MNGR_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
    dept_info = models.IntegerField(db_column='DEPT_INFO', blank=True, null=True)  # Field name made lowercase.
    grp_no = models.IntegerField(db_column='GRP_NO', blank=True, null=True)  # Field name made lowercase.
    atend_info = models.IntegerField(db_column='ATEND_INFO', blank=True, null=True)  # Field name made lowercase.
    salary_info = models.IntegerField(db_column='SALARY_INFO', blank=True, null=True)  # Field name made lowercase.
    logo_id = models.IntegerField(db_column='LOGO_ID', blank=True, null=True)  # Field name made lowercase.
    remark = models.CharField(db_column='REMARK', max_length=500, blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    reg_id = models.CharField(db_column='REG_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
...
class ComGrpinfo(models.Model):
    grp_no = models.IntegerField(db_column='GRP_NO', primary_key=True)  # Field name made lowercase.
    grp_type = models.CharField(db_column='GRP_TYPE', max_length=1, blank=True, null=True)  # Field name made lowercase.
    grp_nm = models.CharField(db_column='GRP_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    state = models.CharField(db_column='STATE', max_length=1, blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    reg_id = models.CharField(db_column='REG_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
    upt_dtime = models.DateTimeField(db_column='UPT_DTIME', blank=True, null=True)  # Field name made lowercase.
...
class ComHday(models.Model):
    std_year = models.CharField(db_column='STD_YEAR', primary_key=True, max_length=4)  # Field name made lowercase.
    hday_date = models.CharField(db_column='HDAY_DATE', max_length=4)  # Field name made lowercase.
    hday_nm = models.CharField(db_column='HDAY_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    type = models.CharField(db_column='TYPE', max_length=1, blank=True, null=True)  # Field name made lowercase.
    remark = models.CharField(db_column='REMARK', max_length=200, blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    applc_dtime = models.DateTimeField(db_column='APPLC_DTIME', blank=True, null=True)  # Field name made lowercase.
...
class ComIcmtaxrt(models.Model):
    std_year = models.CharField(db_column='STD_YEAR', primary_key=True, max_length=4)  # Field name made lowercase.
    taxt_std_lwlt = models.DecimalField(db_column='TAXT_STD_LWLT', max_digits=13, decimal_places=0)  # Field name made lowercase.
    taxt_std_uplt = models.DecimalField(db_column='TAXT_STD_UPLT', max_digits=13, decimal_places=0)  # Field name made lowercase.
    taxrt = models.DecimalField(db_column='TAXRT', max_digits=5, decimal_places=3, blank=True, null=True)  # Field name made lowercase.
    dedn_amt = models.DecimalField(db_column='DEDN_AMT', max_digits=13, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    applc_dtime = models.DateTimeField(db_column='APPLC_DTIME', blank=True, null=True)  # Field name made lowercase.
...
class ComInsrncrate(models.Model):
    std_date = models.DateField(db_column='STD_DATE', primary_key=True)  # Field name made lowercase.
    irncf_type = models.CharField(db_column='IRNCF_TYPE', max_length=2)  # Field name made lowercase.
...
class ComSalarylst(models.Model):
    ...
    lcode = models.CharField(db_column='LCODE', max_length=4)  # Field name made lowercase.
    scode = models.CharField(db_column='SCODE', max_length=6)  # Field name made lowercase.
    salary_type = models.CharField(db_column='SALARY_TYPE', max_length=1, blank=True, null=True)  # Field name made lowercase.
    item_nm = models.CharField(db_column='ITEM_NM', max_length=30, blank=True, null=True)  # Field name made lowercase.
    taxt_yn = models.CharField(db_column='TAXT_YN', max_length=1, blank=True, null=True)  # Field name made lowercase.
    trmmg_unit = models.CharField(db_column='TRMMG_UNIT', max_length=1, blank=True, null=True)  # Field name made lowercase.
    use_yn = models.CharField(db_column='USE_YN', max_length=1, blank=True, null=True)  # Field name made lowercase.
...
class ComSmpltax(models.Model):
    std_year = models.CharField(db_column='STD_YEAR', primary_key=True, max_length=4)  # Field name made lowercase.
    salary_above = models.DecimalField(db_column='SALARY_ABOVE', max_digits=13, decimal_places=0)  # Field name made lowercase.
    salary_belo = models.DecimalField(db_column='SALARY_BELO', max_digits=13, decimal_places=0)  # Field name made lowercase.
    fmly_num_1 = models.IntegerField(db_column='FMLY_NUM_1', blank=True, null=True)  # Field name made lowercase.
    fmly_num_2 = models.IntegerField(db_column='FMLY_NUM_2', blank=True, null=True)  # Field name made lowercase.
    fmly_num_3 = models.IntegerField(db_column='FMLY_NUM_3', blank=True, null=True)  # Field name made lowercase.
    fmly_num_4 = models.IntegerField(db_column='FMLY_NUM_4', blank=True, null=True)  # Field name made lowercase.
    fmly_num_5 = models.IntegerField(db_column='FMLY_NUM_5', blank=True, null=True)  # Field name made lowercase.
    fmly_num_6 = models.IntegerField(db_column='FMLY_NUM_6', blank=True, null=True)  # Field name made lowercase.
    fmly_num_7 = models.IntegerField(db_column='FMLY_NUM_7', blank=True, null=True)  # Field name made lowercase.
    fmly_num_8 = models.IntegerField(db_column='FMLY_NUM_8', blank=True, null=True)  # Field name made lowercase.
    fmly_num_9 = models.IntegerField(db_column='FMLY_NUM_9', blank=True, null=True)  # Field name made lowercase.
    fmly_num_10 = models.IntegerField(db_column='FMLY_NUM_10', blank=True, null=True)  # Field name made lowercase.
    fmly_num_11 = models.IntegerField(db_column='FMLY_NUM_11', blank=True, null=True)  # Field name made lowercase.
    reg_dtime = models.DateTimeField(db_column='REG_DTIME', blank=True, null=True)  # Field name made lowercase.
    applc_dtime = models.DateTimeField(db_column='APPLC_DTIME')  # Field name made lowercase.
...
class ComTml(models.Model):
    corp_no = models.IntegerField(db_column='CORP_NO', primary_key=True)  # Field name made lowercase.
    model_id = models.CharField(db_column='MODEL_ID', max_length=30)  # Field name made lowercase.
...
class EtcTmllog(models.Model):
    ...
    empl_no = models.CharField(db_column='EMPL_NO', max_length=50)  # Field name made lowercase.
    tml_id = models.IntegerField(db_column='TML_ID')  # Field name made lowercase.
    rcv_dtime = models.DateTimeField(db_column='RCV DTIME', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class HrmAtend(models.Model):
    empl_no = models.CharField(db_column='EMPL_NO', primary_key=True, max_length=50)  # Field name made lowercase.
    corp_no = models.IntegerField(db_column='CORP_NO')  # Field name made lowercase.
    dept_no = models.CharField(db_column='DEPT_NO', max_length=6)  # Field name made lowercase.
...
class HrmEmpl(models.Model):
    ...
    empl_no = models.CharField(db_column='EMPL_NO', max_length=50)  # Field name made lowercase.
    ofcps = models.CharField(db_column='OFCPS', max_length=6, blank=True, null=True)  # Field name made lowercase.
    empl_nm = models.CharField(db_column='EMPL_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    prsl_email = models.CharField(db_column='PRSL_EMAIL', max_length=40, blank=True, null=True)  # Field name made lowercase.
    ...
    photo_id = models.IntegerField(db_column='PHOTO_ID', blank=True, null=True)  # Field name made lowercase.
    reg_id = models.CharField(db_column='REG_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
    frgnr_yn = models.CharField(db_column='FRGNR_YN', max_length=1, blank=True, null=True)  # Field name made lowercase.
    tel_no = models.CharField(db_column='TEL_NO', max_length=30, blank=True, null=True)  # Field name made lowercase.
    mobile_no = models.CharField(db_column='MOBILE_NO', max_length=30, blank=True, null=True)  # Field name made lowercase.
    ...
    upt_dtime = models.DateTimeField(db_column='UPT_DTIME', blank=True, null=True)  # Field name made lowercase.
    ssid_addr = models.CharField(db_column='SSID_ADDR', max_length=255, blank=True, null=True)  # Field name made lowercase.
    rlrsdnc_addr = models.CharField(db_column='RLRSDNC_ADDR', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class HrmFmly(models.Model):
    ...
    constnt_nm = models.CharField(db_column='CONSTNT_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    brthdy = models.DateField(db_column='BRTHDY', blank=True, null=True)  # Field name made lowercase.
...
class HrmSalary(models.Model):
    ...
    rperins_pay_yn = models.CharField(db_column='RPERINS_PAY_YN', max_length=1, blank=True, null=True)  # Field name made lowercase.
    wthtx_taxrt = models.DecimalField(db_column='WTHTX_TAXRT', max_digits=5, decimal_places=3, blank=True, null=True)  # Field name made lowercase.
    upt_dtime = models.DateTimeField(db_column='UPT_DTIME', blank=True, null=True)  # Field name made lowercase.
    upt_id = models.CharField(db_column='UPT_ID', max_length=15, blank=True, null=True)  # Field name made lowercase.
...
class HtmEmplphoto(models.Model):
    photo_id = models.IntegerField(db_column='PHOTO_ID', primary_key=True)  # Field name made lowercase.
    file_org_nm = models.CharField(db_column='FILE_ORG_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    file_modify_nm = models.CharField(db_column='FILE_MODIFY_NM', max_length=50, blank=True, null=True)  # Field name made lowercase.
    file_path = models.CharField(db_column='FILE_PATH', max_length=200, blank=True, null=True)  # Field name made lowercase.
    file_size = models.IntegerField(db_column='FILE_SIZE', blank=True, null=True)  # Field name made lowercase.
...
class SlmAnntydtl(models.Model):
    ...
    frgnr_yn = models.CharField(db_column='FRGNR YN', max_length=1, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    anntypay_num = models.IntegerField(db_column='ANNTYPAY NUM', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    anntypay_amt = models.DecimalField(db_column='ANNTYPAY AMT', max_digits=13, decimal_places=0, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    dtrmcexp_icny = models.CharField(db_column='DTRMCEXP ICNY', max_length=1, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class SlmSalarydtl(models.Model):
    ...
    empl_no = models.CharField(db_column='EMPL_NO', max_length=50)  # Field name made lowercase.
    salary_ymon = models.CharField(db_column='SALARY_YMON', max_length=6)  # Field name made lowercase.
    item_type = models.CharField(db_column='ITEM TYPE', max_length=4, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    item_cd = models.CharField(db_column='ITEM CD', max_length=4, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    item_nm = models.CharField(db_column='ITEM NM', max_length=30, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    sort_seq = models.IntegerField(db_column='SORT SEQ', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
