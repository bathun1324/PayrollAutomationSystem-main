...
class EmployeelistAPISearch(APIView):
    def get(self, request):
        # url = `http://13.125.117.184:8000/search_employeelist/?employee_encpnd=${encpnd}&department_no=${deptno}&employee_rspofc=${rspofc}`
...
class RetireemployeelistAPISearch(APIView):
    def get(self, request):
        # `http://13.125.117.184:8000/search_retireemployeelist/?encpnd=${searchtext.encpnd}&retire_date=${searchtext.retire_date}&dept_id=${searchtext.dept_id}`
