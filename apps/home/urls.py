...
urlpatterns = [
    ...
    path('get_codesalaryform/', CodeSalaryFormAPIView.as_view()),
    path('get_codetrnbank/', CodeTrnBankAPIView.as_view()),
    path('get_codefmlyreltn/', CodeFmlyReltnAPIView.as_view()),
]
